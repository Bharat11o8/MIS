  ...
  return (
    <div className="card-premium overflow-hidden">
      <div className="p-6 pb-4">
        ...
        <p className="text-[11px] text-gray-400">Annual-span columns from the sheet itself — kept apart from the monthly trends above</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-gray-50/50">
              ...
              <th className="text-left text-[10px] font-bold uppercase tracking-wider text-gray-400 px-3 py-2">Section</th>
              <th className="text-left text-[10px] font-bold uppercase tracking-wider text-gray-400 px-3 py-2">Period</th>
              <th className="text-right text-[10px] font-bold uppercase tracking-wider text-gray-400 px-3 py-2">Amount</th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-50">
            {rows.map((r, i) => (
              <tr key={`${r.line_key}-${r.period_start_date}-${i}`}>
                ...
                <td className="px-3 py-2.5 text-[10px] font-bold uppercase tracking-wider text-gray-300 whitespace-nowrap">
